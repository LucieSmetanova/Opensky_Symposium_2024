...
def calculate_hfe_week(year, month, week):
    ...
    output_filename = "Output_files\PIs\PIs_horizontal_by_flight_" + year + '_' +  month + '_week' + str(week) + ".csv"
...
def calculate_hfe_week_runway(runway, year, month, week):
    ...
    input_filename = "Cluster data\osn_"+ AIRPORT_ICAO + "_states_TMA_rwy" + runway + "_" + year + "_" + month + "_cluster"+cluster+".csv"
    full_input_filename = input_filename
